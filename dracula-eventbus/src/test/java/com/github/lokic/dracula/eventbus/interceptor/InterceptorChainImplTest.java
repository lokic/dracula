...
public class InterceptorChainImplTest {
    ...
    public void test_parseEnabledInterceptorAttributes() {
        ...
        InterceptorAttribute<TestEvent> interceptorAttribute1 = new InterceptorAttribute<>(new SpyExtensionInterceptor<>("A", 0));
        InterceptorAttribute<TestEvent> interceptorAttribute2 = new InterceptorAttribute<>(new SpyExtensionInterceptor<>("B", 1));
        InterceptorAttribute<TestEvent> interceptorAttribute3 = new InterceptorAttribute<>(new SpyExtensionInterceptor<>("C", 2));
