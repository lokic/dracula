...
@Slf4j
public class TransactionalEventQueue<E extends Event> extends SimpleDelegatingQueue<E> {
    ...
    public TransactionalEventQueue(Class<E> genericType, TransactionalEventManager manager) {
        super(genericType);
    ...
    public void setTargetPublisher(Publisher<E> publisher) {
        super.setTargetPublisher(publisher);
